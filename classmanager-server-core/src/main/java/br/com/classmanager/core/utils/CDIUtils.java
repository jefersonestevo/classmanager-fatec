...
public class CDIUtils {
	...
	/**
	 * 
	 * Retorna o bean gerenciado pelo CDI que possuir o nome informado.
	 * 
	 * @param clazzName
	 *            - Nome do Bean para ser retornado
	 * @param bm
	 *            - BeanManager do CDI.
	 * @return - Bean gerenciado pelo CDI ou null caso nenhum seja encontrado.
	 */
	...
	/**
	 * 
	 * Retorna o bean gerenciado pelo CDI que for da classe informada.
	 * 
	 * @param clazzName
	 *            - Classe do bean a ser retornado
	 * @param bm
	 *            - BeanManager do CDI.
	 * @return - Bean gerenciado pelo CDI ou null caso nenhum seja encontrado.
	 */
